...
class Desugaring extends ToolSuite("testsMeta") {
  test("simple transform") {
    ...
    assert(
      ...
      |        case (value: meta.Defn.Object)Some[meta.Defn.Object]((quasiquote$macro$1$result$0 @ _)) => scala.Some.apply[meta.Defn.Object](quasiquote$macro$1$result$0)
      |        case _ => scala.None
      |      }
      |    }
      |  };
